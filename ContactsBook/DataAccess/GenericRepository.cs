...
namespace ContactsBook.DataAccess
{
    public class GenericRepository : IRepository
    {
		...
		/// <param name="criteria">The criteria.</param>
		/// <returns></returns>
		public IEnumerable<TEntity> FindInclude<TEntity>(string children, Expression<Func<TEntity, bool>> criteria) where TEntity : class
		{
			return GetQuery<TEntity>().Where(criteria).Include(children);
        }
